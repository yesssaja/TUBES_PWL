...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {{-- HEADER --}}
    <div class="bg-gradient-to-r from-red-600 via-orange-500 to-yellow-400 rounded-3xl shadow-lg p-6 sm:p-8 text-white mb-8">
        <h1 class="text-3xl sm:text-4xl font-black">
            Lamaran Masuk
        </h1>

        <p class="text-white/90 mt-3 text-base sm:text-lg">
    ...
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                        ...
                        <tr class="hover:bg-orange-50/50 transition">
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-4">
                                    <img src="{{ $foto }}" class="w-14 h-14 rounded-2xl object-cover shadow-sm border">
                            ...
                            <td class="px-6 py-5">
                                @if($lamaran->status_lamaran == 'diterima')
                                    <span class="bg-green-100 text-green-600 px-4 py-2 rounded-full text-sm font-bold">Diterima</span>
                                @elseif($lamaran->status_lamaran == 'ditolak')
                                    <span class="bg-red-100 text-red-600 px-4 py-2 rounded-full text-sm font-bold">Ditolak</span>
                                @else
                                    <span class="bg-yellow-100 text-yellow-600 px-4 py-2 rounded-full text-sm font-bold">Pending</span>
                                @endif
                            </td>
        ...
        {{-- MOBILE CARD --}}
        <div class="lg:hidden p-4 sm:p-6 space-y-5">
            ...
            @forelse ($lamarans as $lamaran)
                ...
                <div class="border border-gray-100 rounded-3xl p-5 shadow-sm bg-white">
                    ...
                    <div class="mt-5 space-y-3 text-sm">
                        <div>
                            <p class="text-gray-400 font-semibold">Lowongan</p>
                        ...
                        <div>
                            <p class="text-gray-400 font-semibold">Tanggal</p>
                        ...
                        <div>
                            ...
                            @if($lamaran->status_lamaran == 'diterima')
                                <span class="inline-flex bg-green-100 text-green-600 px-4 py-2 rounded-full text-sm font-bold mt-1">Diterima</span>
                            @elseif($lamaran->status_lamaran == 'ditolak')
                                <span class="inline-flex bg-red-100 text-red-600 px-4 py-2 rounded-full text-sm font-bold mt-1">Ditolak</span>
                            @else
                                <span class="inline-flex bg-yellow-100 text-yellow-600 px-4 py-2 rounded-full text-sm font-bold mt-1">Pending</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        @if($lamaran->cv)
                            <a href="{{ asset('storage/' . $lamaran->cv) }}" target="_blank"
                               class="text-center bg-blue-100 text-blue-600 px-4 py-3 rounded-xl font-bold hover:bg-blue-200 transition">
                                Lihat CV
                            </a>
                        @else
                            <div class="text-center bg-gray-100 text-gray-400 px-4 py-3 rounded-xl font-bold">
                                CV -
                            </div>
                        @endif
                        ...
                        @if($lamaran->portfolio)
                            <a href="{{ $lamaran->portfolio }}" target="_blank"
                               class="text-center bg-purple-100 text-purple-600 px-4 py-3 rounded-xl font-bold hover:bg-purple-200 transition">
                                Portfolio
                            </a>
                        @else
                            <div class="text-center bg-gray-100 text-gray-400 px-4 py-3 rounded-xl font-bold">
                        ...
                        <a href="{{ route('perusahaan.lamaran.show', $lamaran->id) }}"
                           class="text-center bg-red-600 hover:bg-red-700 text-white px-4 py-3 rounded-xl font-bold shadow transition">
                            Detail
                        </a>
                    </div>
