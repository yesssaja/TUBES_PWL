    ...
    <div class="bg-white rounded-3xl shadow-lg p-8">
        ...
        <form class="space-y-8">
            ...
            <div>
                ...
                <textarea
                    rows="7"
                    class="w-full border border-gray-300 rounded-2xl p-4 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition">Membuat desain aplikasi dan website yang modern, menarik, dan user friendly.</textarea>
            ...
            <div>
                ...
                <textarea
                    rows="5"
                    class="w-full border border-gray-300 rounded-2xl p-4 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition"></textarea>
