        ...
        <section class="relative z-10 min-h-screen flex items-center justify-center px-4 py-10">
            ...
            <div class="w-full max-w-3xl bg-white rounded-[32px] shadow-xl px-8 py-10">
                ...
                <form action="{{ route('profile.pelamar.store') }}" method="post" enctype="multipart/form-data"
                    ...
                    @csrf
                    <div>
                        <label for="foto_diri" class="block text-sm font-bold text-[#1B2540] mb-2">
                            Foto Diri <span class="text-red-600">*</span>
                        </label>

                        <input type="file" name="foto_diri" id="foto_diri" accept="image/*" required
                            class="block w-full px-5 py-4 rounded-2xl border border-red-100 bg-white text-sm text-[#1B2540]">

                        <x-input-error :messages="$errors->get('foto_diri')" class="mt-2 text-sm text-red-600"></x-input-error>
                    </div>
                    <div>
                        <label for="nik" class="block text-sm font-bold text-[#1B2540] mb-2">
                            NIK <span class="text-red-600">*</span>
                        </label>

                        <x-text-input type="text" name="nik" id="nik" placeholder="Masukkan 16 digit NIK"
                            maxlength="16" required
                            class="block w-full px-5 py-4 rounded-2xl border border-red-100 bg-white text-sm text-[#1B2540]"></x-text-input>

                        <x-input-error :messages="$errors->get('nik')" class="mt-2 text-sm text-red-600"></x-input-error>
                    </div>
                    <div>
                        <label for="tempat_lahir" class="block text-sm font-bold text-[#1B2540] mb-2">
                    ...
                    <div>
                        <label for="tgl_lahir" class="block text-sm font-bold text-[#1B2540] mb-2">
                            Tanggal Lahir <span class="text-red-600">*</span>
                        </label>

                        <x-text-input type="date" name="tgl_lahir" id="tgl_lahir"
                    ...
                    <div>
                        <label for="gender" class="block text-sm font-bold text-[#1B2540] mb-2">
                    ...
                    <div>
                        <label for="no_hp" class="block text-sm font-bold text-[#1B2540] mb-2">
                            No HP <span class="text-red-600">*</span>
                        </label>

                        <x-text-input type="text" name="no_hp" id="no_hp" placeholder="Masukkan nomor HP"
                            required
                            class="block w-full px-5 py-4 rounded-2xl border border-red-100 bg-white text-sm text-[#1B2540]"></x-text-input>
                    ...
                    <div>
                        <label for="foto_ktp" class="block text-sm font-bold text-[#1B2540] mb-2">
                            Foto KTP <span class="text-red-600">*</span>
                        </label>
                    ...
                    <div>
                        <label for="foto_ijazah" class="block text-sm font-bold text-[#1B2540] mb-2">
                            Foto Ijazah <span class="text-red-600">*</span>
                        </label>

                        <input type="file" name="foto_ijazah" id="foto_ijazah" accept="image/*" required
                            class="block w-full px-5 py-4 rounded-2xl border border-red-100 bg-white text-sm text-[#1B2540]">
                    ...
                    <div>
                        <button type="submit"
                            class="w-full bg-[#E71F25] hover:bg-red-700 text-white py-4 rounded-2xl font-bold text-sm transition duration-300">
                            Verifikasi Email
                        </button>
                    </div>
                </form>
