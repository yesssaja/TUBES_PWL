                    ...
                    <div class="grid lg:grid-cols-4 gap-4">
                        ...
                        <div class="lg:col-span-2">
                            <input type="text"
                                ...
                                placeholder="Cari jasa, freelancer, lokasi, atau skill..."
...
@section('script')
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function searchServices() {
            ...
            const url = `{{ route('service.search.ajax') }}?search=${encodeURIComponent(search)}&category=${encodeURIComponent(category)}&location=${encodeURIComponent(location)}`;
                ...
                .then(data => {
                    ...
                    data.services.forEach(service => {
                        const imageHtml = service.image_url
                            ? `<img src="${service.image_url}" alt="${service.service_name}" class="h-52 w-full object-cover flex-shrink-0">`
                            : `<div class="h-52 w-full bg-red-100 flex items-center justify-center text-primary font-bold flex-shrink-0">Tidak Ada Gambar</div>`;
        ...
        searchInput.addEventListener('input', function () {
            ...
            typingTimer = setTimeout(searchServices, 300);
        });
