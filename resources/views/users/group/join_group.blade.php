...
<div class="group-page">
    ...
    <div class="comment-card rounded-[28px] p-5 relative"
        ...
        <div class="flex items-start justify-between gap-3 mb-4">
            ...
            @auth
                @if(Auth::user()->id === $comment->pelamar_id)
                    <div class="relative z-10">
                        <form action="{{ route('groups.comment.destroy', $comment->id) }}" 
                              method="POST" 
                            ...
                            <button type="submit" 
                                    class="p-2 text-gray-400 hover:text-red-600 rounded-xl hover:bg-red-50 transition-colors duration-200"
