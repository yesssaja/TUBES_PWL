...
@section('content')
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-white/90 font-medium">
                        Perbarui data group yang sudah tersimpan.
                    </p>
                </div>
            </div>
    ...
    <div class="bg-white rounded-[30px] shadow-soft border border-slate-100 overflow-hidden">
        ...
        <div class="px-7 py-6 border-b border-slate-100 flex items-center justify-between gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Pastikan informasi group sudah benar sebelum disimpan.
                </p>
            </div>
        ...
        <form action="{{ route('admin.groups.update', $group->slug) }}"
            method="POST"
            class="p-7">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea name="description"
                        rows="5"
                        class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3.5 font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition resize-none">{{ old('description', $group->description) }}</textarea>
                </div>
