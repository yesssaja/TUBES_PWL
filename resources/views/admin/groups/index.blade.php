        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full min-w-[900px]">
                ...
                <thead class="bg-red-600 text-white">
                    <tr>
                        <th class="p-4 text-left text-sm uppercase tracking-wide">Nama Group</th>
                        <th class="p-4 text-left text-sm uppercase tracking-wide">Kategori</th>
                        <th class="p-4 text-center text-sm uppercase tracking-wide">Anggota</th>
