    ...
    <header class="bg-red-brand text-white p-4 shadow-lg sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 font-medium">
                ...
                <a href="{{ route('perusahaan.detail') }}" class="hover:text-yellow-300">Company</a>
            </nav>
        </div>
    </header>
            ...
            @forelse($lokers as $loker)
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition">
                    ...
                    <div class="p-6 -mt-12">
                        ...
                        <img src="{{ $logoPerusahaan }}" alt="Logo Perusahaan" class="w-20 h-20 rounded-xl border-4 border-white shadow-md bg-white object-contain mb-4">
                        ...
                        <a href="{{ route('loker.show', $loker->id) }}" class="block text-center bg-red-brand hover:bg-red-700 text-white px-6 py-3 rounded-full font-bold shadow-lg transition-all transform hover:scale-105">
                            Lihat Detail
                        </a>
